...
func AddProduct(c *gin.Context) {
	...
	product := model.Product{Product_name: body.Product_name, Category: body.category, StoreID: store.StoreID, Stock: body.Stock, Price_Each: body.Price, Description: body.Description}
